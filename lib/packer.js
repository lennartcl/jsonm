...
exports.Packer = function(json) {
    ...
    function pack(object) {
        ...
        function packObject(object) {
            ...
            if (isError)
                results.push(packValue(object.message), packValue(object.stack));
            
            return results;
        }
        
        function packErrorKeys(object, results) {
            if (object instanceof Error && typeof object.message === "string" && typeof object.stack === "string") {
                results.push("message", "stack");
                return true;
            }
        }
