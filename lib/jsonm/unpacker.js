...
module.exports.Unpacker = function() {
    ...
    var packerDictStart = NON_TYPE_START;
    ...
    function unpack(packed) {
        ...
        if (dict.length - newDictStart > MAX_MEMO_DICT_SIZE) {
            var newStart = packerDictStart = dict.length - (MAX_MEMO_DICT_SIZE / 2);
            setTimeout(function gc() {
                dict = dict.slice(newStart - dictStart);
                dictStart = newStart;
